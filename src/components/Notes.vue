		...
		<div style="width: 1300px;margin: 0px auto;">
			...
			<div class="lunbo" style="margin-top: 30px;">
				...
				<el-carousel :interval="3000" type="card" height="300px">
					<el-carousel-item>
						<h3><img src="../assets/li.jpg" style="width: 100%;height: 350px;" /></h3>
					</el-carousel-item>
					<el-carousel-item>
						<h3><img src="../assets/mihoutao.jpg" style="width: 100%;height: 350px;" /></h3>
					</el-carousel-item>
					<el-carousel-item>
						<h3><img src="../assets/pingguo.jpg" style="width: 100%;height: 350px;" /></h3>
					</el-carousel-item>
					<el-carousel-item>
						<h3><img src="../assets/peigen.jpg" style="width: 100%;height: 350px;" /></h3>
					</el-carousel-item>
